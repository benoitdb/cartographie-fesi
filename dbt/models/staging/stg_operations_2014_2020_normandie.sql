...
SELECT
    ...
    "Total des dépenses éligibles - Total eligible costs" AS depenses_eligibles,
    "Montant UE programmé" AS montant_ue,
    "taux de cofinancement UE - EU co-financing rate" AS taux_cofinancement,
    "date début op. / start" AS date_debut,
    "date fin d'op. / end" AS date_fin,
