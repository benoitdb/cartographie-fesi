...
SELECT
    ...
    "Funds" AS fonds,
    TRY_CAST("Operation start date" AS DATE) AS date_debut,
    TRY_CAST("Operation end date" AS DATE) AS date_fin,
    TRY_CAST("Total amount programmed" AS NUMERIC) AS depenses_eligibles,
    TRY_CAST("Amount co-financing European Union" AS NUMERIC) AS montant_ue,
    TRY_CAST("Union co-financing rate (%)" AS NUMERIC) AS taux_cofinancement,
    "Country" AS pays,
